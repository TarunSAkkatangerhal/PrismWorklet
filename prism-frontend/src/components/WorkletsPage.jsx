...
export default function WorkletsPage() {
  ...
  const filteredWorklets = workletsData.filter(worklet => {
    ...
    const matchesSearch = worklet.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         worklet.mentor.toLowerCase().includes(searchTerm.toLowerCase()) ||
          ...
          <div className="flex flex-col lg:flex-row gap-6 mb-8">
            ...
            <div className="relative flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search worklets, mentors, or colleges..."
                  value={searchTerm}
                    ...
                    <div className="px-8 py-6 bg-gradient-to-r from-slate-50/80 to-white/80 dark:from-slate-700/30 dark:to-slate-800/50 
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        ...
                        <div className="flex items-center space-x-2 text-slate-500 dark:text-slate-400">
                          ...
                          <span className="truncate font-medium">{worklet.mentor}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <tr key={worklet.id} 
                        ...
                        <td className="px-8 py-6">
                          <div className="flex items-center space-x-2 text-slate-600 dark:text-slate-400">
                            ...
                            <span className="text-sm font-medium truncate max-w-32">{worklet.mentor}</span>
                          </div>
                        </td>
                      </tr>
                    ))}
