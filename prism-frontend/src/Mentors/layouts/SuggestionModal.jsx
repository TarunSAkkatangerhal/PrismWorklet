...
export default function SuggestionModal({ isOpen, onClose, workletId, preSelectedWorklet, onSuccess, onError }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onClose();
      if (onSuccess) {
        onSuccess("Suggestion submitted successfully! Students have been notified.");
      }
      ...
      onClose();
      if (onError) {
        onError("Failed to submit suggestion. Please try again.");
      }
    } finally {
      setLoading(false);
    }
